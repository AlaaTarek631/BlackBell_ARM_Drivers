...
{
    MGPIO_voidSetPinDirection_Mode(HTFT_A0_PORT_PIN ,OUTPUT, GPIO_PUSH_PULL); // PA0 A0
    //MGPIO_voidSetPinDirection_Mode(HTFT_CS_PORT_PIN , OUTPUT, GPIO_PUSH_PULL); // PA1 CS
    MGPIO_voidSetPinDirection_Mode(HTFT_RST_PORT_PIN ,OUTPUT, GPIO_PUSH_PULL); // PA1 CS
	
    MGPIO_voidSetPinSpeed(HTFT_A0_PORT_PIN, MGPIO_LOW_SPEED);
	//MGPIO_voidSetPinSpeed(HTFT_CS_PORT_PIN, MGPIO_LOW_SPEED);
	MGPIO_voidSetPinSpeed(HTFT_RST_PORT_PIN, MGPIO_LOW_SPEED);
